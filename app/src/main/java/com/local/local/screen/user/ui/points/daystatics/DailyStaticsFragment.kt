...
class DailyStaticsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_daily_statics, container, false)
    }
    ...
    private val viewModel: DailyStaticsViewModel by viewModel()
